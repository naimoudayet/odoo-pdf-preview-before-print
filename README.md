...
![Version](https://img.shields.io/badge/version-17.0.1.4.0-informational)
...
The dev stack lives on the **`17.0-dev`** branch - `Dockerfile` and
...
```bash
docker exec -it pdfprev-odoo-17 \
...
**`17.0-dev`**; the specs and the wrapper ship on every branch.
